...
If a simplex $\sigma$ is a face of $\tau$, we say that $\tau$ is a \emph{coface} of $\sigma$ \mdeff{Only define what is used.}.
...
\mdeff{I think it's important to show how easy is the abstract description to actually implement. Maybe as a paragraph with $B$ and $L$ in a basis? Needed for Figure 1 anyhow.}
...
\mdeff{The commented sentence would be useful to non-topologists. Maybe a footnote?}
