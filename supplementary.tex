...
\textbf{(A) Localizing property of powers of the Laplacian.} \gard{Move some stuff here}.


\textbf{(B) Statistics on the simplicial complexes}
...
\textbf{(C) Glossary Missing Data Imputation} We state here some definitions and criteria that are used in the results section. 
