...
\label{table:data}%
\end{minipage}%
\savebox{\tempbox}{\includegraphics[height=2.3cm]{./figures/sc.png}}%
\settowidth{\tempwidth}{\usebox{\tempbox}}%
\hfil\begin{minipage}[b]{\tempwidth}%
\raisebox{-\height}{\usebox{\tempbox}}%
...
\end{minipage}%
%\end{table*}
\caption{Constructing a simplicial complex from data. (a) Coauthorship data. (b) Coauthorship complex. (c) Degree-$1$ Laplacian of the coauthorship complex.}\label{fig:data2complex}
\end{figure}
...
We report in the following table the number of simplices in dimension $k=0,1,2$ of the coauthorship complexes CC1 and CC2. In Figure~\ref{fig:dist-cochains} we show the distribution of the values of the cochains in CC1 and CC2.
\begin{table}[htbp]
  \centering
  \scriptsize{
