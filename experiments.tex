...
\begin{table}[htbp]
 ...
 \mdeff{Align on period and $\pm$.}\stefania{@Gard @Michael, do you know how to do this in a simple way?}
...
\vspace{-0.5cm}
 ...
 % \caption{Distribution of the prediction's error} \label{fig:error}
\end{subfigure}
\caption{(a) Mean Accuracy $\pm$ std over 5 samples of SNN in imputing missing citations on CC1. (b) Distribution of the Absolute Error of the SNN for $40\%$ missing values in CC1.  \mdeff{I don't get (b).}\stefania{There was some text there that should have been removed. It is the distribution of the absolute error of the SNN for 1 sample when $40\%$ of the data is missing. Is it clear like this?} \mdeff{Some space could be claimed from this figure.}\stefania{Yep. With Grad we were thinking the same :)}}
\label{fig:accuracy-error}
\end{figure}