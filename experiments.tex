...
%\subsection{Results}
\textbf{Results.} \gard{Note for me to remember to add a punchline somewhere in this section :-)}
...
\begin{table}[htbp]
  ...
  \end{tabular}}
  \caption{%
 Mean Accuracy $\pm$ standard deviation over 5 samples using statistical methods. \stefania{Add actual values}
