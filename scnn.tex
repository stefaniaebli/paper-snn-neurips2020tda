...
\mdeff{This definition is problematic: We can only meaningfully convolve two cochains when we can shift/move a cochain on the complex (like translation for Euclidean conv, or in general the action of a symmetry group).}
...
\stefania{What about moving the following explanation to the appendix?}
\mdeff{Agreed, if it can't be shortened.}
