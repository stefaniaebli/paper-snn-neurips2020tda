...
\stefania{Comments i)write the matrix form of the operations using U since the beginning? ii)maybe shorter intro it can be too convoluted for someone reading this things for the first time iii)we need to cite Barbarossa..}
