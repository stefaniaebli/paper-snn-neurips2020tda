...
\end{center}
\begin{center}
Coautorship complexes are built from the Semantic Scholar dataset \cite{2} where missing citations are introduced at random on the $k$-cochains ($k=1,2,3$) at five rates: $10\%, 20\%,  30\%, 30\%$, and $50\%$.
